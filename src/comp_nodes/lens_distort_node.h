 ...
 * ====================================================================
 *
 * Perform lens distortion on an image stream.
 */

#ifndef OPENCOMPGRAPHMAYA_LENS_DISTORT_NODE_H
#define OPENCOMPGRAPHMAYA_LENS_DISTORT_NODE_H
...
class LensDistortNode : public BaseNode {
public:
    LensDistortNode();

    virtual ~LensDistortNode();
...
#endif // OPENCOMPGRAPHMAYA_LENS_DISTORT_NODE_H
